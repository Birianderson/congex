<template>
    <div id="staticBackdrop" class="modal fade" :class="{'modal-sm': (size === 'sm'), 'modal-md': (size === 'md'), 'modal-lg': (size === 'lg'), 'modal-xl': (size === 'xl'), 'modal-xxl': (size === 'xxl')}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
